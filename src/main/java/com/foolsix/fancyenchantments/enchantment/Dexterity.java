...
public class Dexterity extends AerEnchantment {
    ...
    public void addRange(ItemAttributeModifierEvent e) {
        ...
        if (level > 0 && e.getSlotType() == EquipmentSlot.MAINHAND) {
            e.addModifier(ForgeMod.ENTITY_REACH.get(), new AttributeModifier(MODIFIER_UUID, "dexterity modifier", level * CONFIG.rangeMultiplierPerLevel, AttributeModifier.Operation.ADDITION));
        }
    }
}
