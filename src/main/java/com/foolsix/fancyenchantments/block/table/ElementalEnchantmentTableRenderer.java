...
public class ElementalEnchantmentTableRenderer implements BlockEntityRenderer<ElementalEnchantmentTableBlockEntity> {
    public static final ResourceLocation BOOK_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(FancyEnchantments.MODID, "textures/entity/elemental_enchanting_table_book.png");
    ...
    @Override
    public void render(
            ElementalEnchantmentTableBlockEntity blockEntity,
            float partialTick,
            PoseStack poseStack,
