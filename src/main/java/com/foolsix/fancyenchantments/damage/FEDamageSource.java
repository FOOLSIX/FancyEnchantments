...
public class FEDamageSource {
    ...
    public static final DamageType GENERAL_ENCHANTMENT_DAMAGE = new DamageType("general_enchantment_damage", DamageScaling.NEVER, 0.1f);

    private static DamageSource source(@Nonnull LivingEntity living, ResourceKey<DamageType> resourceKey) {
